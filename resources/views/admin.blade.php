  ...
  <body>
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="homepage"><img src="img/Lovelobbyy.png" alt="logo" /> LoveLobby</a>
            ...
            <li class="nav-item nav-profile dropdown">
              ...
              <div class=" dropdown-menu" aria-labelledby="profileDropdown">
                <a class="dropdown-item" href="homepage">
                  <i class="mdi mdi-cached me-2 text-success"></i> LoveLobby Main </a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="LoveLobby">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="adminchart">
                <span class="menu-title">Data___</span>
            ...
            <div class="row">
              <div class="col-md-7 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="clearfix">
                      <h4 class="card-title float-left">Statistics</h4>
